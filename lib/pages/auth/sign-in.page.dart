...
class _SignInPageState extends State<SignInPage> {
                ...
                child: new Column(
                  children: [
                    new TextField(
                      ...
                      controller:
                          isStep1 ? _phoneNumberController : _codeController,
                      keyboardType:
                          isStep1 ? TextInputType.phone : TextInputType.number,
                      autofocus: true,
                    ),
                    new SizedBox(
                      height: 5.0,
  ...
  void _getCode() {
    ...
    signInService.getCode(_phoneNumberController.text).then((http.Response r) {
  ...
  void _getPassword() {
    ...
    signInService
        .getPassword(widget.phoneNumber, _codeController.text)
  ...
  void _saveAccount() {
    SharedPreferences.getInstance().then((SharedPreferences preferences) {
      ...
      Navigator
          .of(context)
          .pushNamedAndRemoveUntil(AppRoutes.contacts, (_) => false);
    }).catchError((e) {
      print(e);
    });
  }
